...
void init_user_sid(void)
{
    ...
    if (!f)
    {
        ...
        if (!gethostuuid( hostid, &timeout ))
        {
            id = ((uint64_t)hostid[0] << 56) | ((uint64_t)hostid[1] << 48) |
                 ((uint64_t)hostid[2] << 40) | ((uint64_t)hostid[3] << 32) |
                 ((uint64_t)hostid[4] << 24) | ((uint64_t)hostid[5] << 16) |
                 ((uint64_t)hostid[6] << 8)  | (uint64_t)hostid[7];
