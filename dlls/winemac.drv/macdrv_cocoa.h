...
#ifndef MACDRV_EXPORT
#if defined(__GNUC__)
#define MACDRV_EXPORT __attribute__((visibility("default")))
#else
#define MACDRV_EXPORT
#endif
#endif
...
extern MACDRV_EXPORT macdrv_metal_device macdrv_create_metal_device(void);
extern MACDRV_EXPORT void macdrv_release_metal_device(macdrv_metal_device d);
extern MACDRV_EXPORT macdrv_metal_view macdrv_view_create_metal_view(macdrv_view v, macdrv_metal_device d);
extern MACDRV_EXPORT macdrv_metal_layer macdrv_view_get_metal_layer(macdrv_metal_view v);
extern MACDRV_EXPORT void macdrv_view_release_metal_view(macdrv_metal_view v);
